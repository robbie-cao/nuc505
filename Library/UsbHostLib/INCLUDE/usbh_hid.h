...
/** @addtogroup NUC505_USBH_HID_Driver USB Host HID Driver
  @{
*/
...
/** @addtogroup NUC505_USBH_HID_EXPORTED_CONSTANTS USB Host HID Driver Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC505_USBH_HID_EXPORTED_CONSTANTS */


struct usbhid_dev;               /*!< HID device structure  \hideinitializer             */


/** @addtogroup NUC505_USBH_HID_EXPORTED_TYPEDEFS USB Host HID Driver Exported Type Define
  @{
*/
...
/*@}*/ /* end of group NUC505_USBH_HID_EXPORTED_TYPEDEFS */


/** @addtogroup NUC505_USBH_HID_EXPORTED_STRUCTURES USB Host HID Driver Exported Structures
  @{
*/
 ...
 *  HID device
 */
typedef struct usbhid_dev {             /*! HID device structure \hideinitializer             */
...
/*@}*/ /* end of group NUC505_USBH_HID_EXPORTED_STRUCTURES */
...
/** @addtogroup NUC505_USBH_HID_EXPORTED_FUNCTIONS USB Host HID Driver Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC505_USBH_HID_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC505_USBH_HID_Driver */
