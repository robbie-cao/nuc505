...
#define URB_MAX_NUM             16      /*!< Maximum number of URBs in memory pool \hideinitializer     */
#define ED_MAX_NUM              16      /*!< Maximum number of OHCI EDs in memory pool \hideinitializer */
...
/*@}*/ /* end of group NUC505_USBH_EXPORTED_CONSTANTS USBH Exported Constants */
