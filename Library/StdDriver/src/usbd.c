...
/** @addtogroup NUC505_USBD_Driver USBD Driver
  @{
*/


/** @addtogroup NUC505_USBD_EXPORTED_FUNCTIONS USBD Exported Functions
  @{
*/
/*--------------------------------------------------------------------------*/
...
void USBD_Open(S_USBD_INFO_T *param, CLASS_REQ pfnClassReq, SET_INTERFACE_REQ pfnSetInterface)
{
	...
	//	USBD->PHYCTL = USBD->PHYCTL | BIT3;		//1 = USB PHY Low Power Mode Disabled.
	//	USBD->PHYCTL = USBD->PHYCTL & ~BIT3;	//1 = USB PHY Low Power Mode Enabled.
 ...
 *
 * @return      Return 0 when Success / Return 1 when Reply STALL.
 *
...
int USBD_GetDescriptor(void)
{
    ...
    case DESC_HID: {
        u32Len = Minimum(u32Len, LEN_HID);
				if(g_usbd_sInfo->gu8HidCompositeDesc != NULL)
						USBD_MemCopy(g_usbd_buf, (uint8_t *)g_usbd_sInfo->gu8HidCompositeDesc, u32Len);
				else				
...
void USBD_CtrlIn(void)
{
    ...
    if(g_usbd_CtrlInSize >= g_usbd_CtrlMaxPktSize) {
        ...
        for (i=0; i<(g_usbd_CtrlInSize % 4); i++)
 ...
 *
 * @param[out]  pu8Buf      Control OUT data pointer
 ...
 *
 * @param   pfnVendorReq         Vendor Request Callback Function
 *
 * @return      None
 *
...
/*@}*/ /* end of group NUC505_USBD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC505_USBD_Driver */
