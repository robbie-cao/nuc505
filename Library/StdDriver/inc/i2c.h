 ...
 * $Revision: 11 $
 * $Date: 14/05/29 1:13p $
 * @brief    NUC505 I2C driver header file
 *
 * @note
...
/** @addtogroup NUC505_I2C_Driver I2C Driver
  @{
*/

/** @addtogroup NUC505_I2C_EXPORTED_CONSTANTS I2C Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC505_I2C_EXPORTED_CONSTANTS */


/** @addtogroup NUC505_I2C_EXPORTED_FUNCTIONS I2C Exported Functions
  @{
*/
...
/**
  * @brief This macro clears wake-up flag.
  * @param[in] i2c is the base address of I2C module.
  * @return none.
  * \hideinitializer
  */
...
/*@}*/ /* end of group NUC505_I2C_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC505_I2C_Driver */
