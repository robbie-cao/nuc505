 ...
 * $Revision: 6 $
 * $Date: 14/05/29 1:13p $
 * @brief    NUC505 TIMER driver header file
 *
 * @note
...
/** @addtogroup NUC505_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
#define TIMER_CAPTURE_FALLING_AND_RISING_EDGE  (2UL << TIMER_EXTCTL_CAPEDGE_Pos)  /*!< Both falling and rising edge trigger timer capture  \hideinitializer */
...
/*@}*/ /* end of group NUC505_TIMER_EXPORTED_CONSTANTS */
...
/**
  ...
  * @param[in] timer The base address of Timer module
  * @return None
  * @note  To wake the system from power down mode, timer clock source must be RTC_CLK
  */
