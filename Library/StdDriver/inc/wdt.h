 ...
 * $Revision: 8 $
 * $Date: 14/05/29 1:13p $
 * @brief    NUC505 WDT driver header file
 *
 * @note
...
/** @addtogroup NUC505_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC505_WDT_EXPORTED_CONSTANTS */
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_RESET_FLAG()  (WDT->CTL = (WDT->CTL & ~(WDT_CTL_IF_Msk | WDT_CTL_WKF_Msk)) | WDT_CTL_RSTFC_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_INT_FLAG() (WDT->CTL = (WDT->CTL & ~(WDT_CTL_RSTFC_Msk | WDT_CTL_WKF_Msk)) | WDT_CTL_IF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_WAKEUP_FLAG() (WDT->CTL = (WDT->CTL & ~(WDT_CTL_RSTFC_Msk | WDT_CTL_IF_Msk)) | WDT_CTL_WKF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_GET_RESET_FLAG() (WDT->RSTSTS & WDT_RSTSTS_RSTF_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define WDT_RESET_COUNTER() (WDT->CTL  = (WDT->CTL & ~(WDT_CTL_IF_Msk | WDT_CTL_WKF_Msk | WDT_CTL_RSTFC_Msk)) | WDT_CTL_RSTCNT_Msk)
...
__STATIC_INLINE void WDT_DisableInt(void)
{
    ...
    WDT->CTL &= ~(WDT_CTL_INTEN_Msk | WDT_CTL_RSTFC_Msk | WDT_CTL_IF_Msk | WDT_CTL_WKF_Msk) ;
    return;
}
