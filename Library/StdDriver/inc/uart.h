 ...
 * $Revision: 21 $
 * $Date: 14/06/07 6:37p $
 * @brief    NUC505 series UART driver header file
 *
 * @note
...
/** @addtogroup NUC505_UART_Driver UART Driver
  @{
*/

/** @addtogroup NUC505_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
#define UART1_FIFO_SIZE 64 /*!< UART1 supports separated receive/transmit 64/64 bytes entry FIFO */
#define UART2_FIFO_SIZE 64 /*!< UART2 supports separated receive/transmit 64/64 bytes entry FIFO */    
...
#define UART_FIFO_RFITL_30BYTES    (0x4 << UART_FIFO_RFITL_Pos)   /*!< UART_FIFO setting to set RX FIFO Trigger Level to 30 bytes */
#define UART_FIFO_RFITL_46BYTES    (0x5 << UART_FIFO_RFITL_Pos)   /*!< UART_FIFO setting to set RX FIFO Trigger Level to 46 bytes */
#define UART_FIFO_RFITL_62BYTES    (0x6 << UART_FIFO_RFITL_Pos)   /*!< UART_FIFO setting to set RX FIFO Trigger Level to 62 bytes */
...
#define UART_FIFO_RTSTRGLV_30BYTES    (0x4 << UART_FIFO_RTSTRGLV_Pos)  /*!< UART_FIFO setting to set RTS Trigger Level to 30 bytes */
#define UART_FIFO_RTSTRGLV_46BYTES    (0x5 << UART_FIFO_RTSTRGLV_Pos)  /*!< UART_FIFO setting to set RTS Trigger Level to 46 bytes */
#define UART_FIFO_RTSTRGLV_62BYTES    (0x6 << UART_FIFO_RTSTRGLV_Pos)  /*!< UART_FIFO setting to set RTS Trigger Level to 62 bytes */
...
/*---------------------------------------------------------------------------------------------------------*/
#define UART_RTS_IS_HIGH_LEV_ACTIVE (0x1 << UART_MODEM_RTSACTLV_Pos) /*!< Set RTS is High Level Active */
#define UART_RTS_IS_LOW_LEV_ACTIVE  (0x0 << UART_MODEM_RTSACTLV_Pos) /*!< Set RTS is Low Level Active */


/*---------------------------------------------------------------------------------------------------------*/
/* UART_IRDA constants definitions                                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define UART_IRDA_TXEN      (1) /*!< Set IrDA function Tx mode */
#define UART_IRDA_RXEN      (0) /*!< Set IrDA function Rx mode */
...
/*@}*/ /* end of group NUC505_UART_EXPORTED_CONSTANTS */


/** @addtogroup NUC505_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
 ...
 *    @param[in]    uart    The base address of UART module
 *
 *    @return       Transmitter FIFO empty register value
 *
 ...
 *    @param[in]    uart    The base address of UART module
 *
 *    @return       Receiver FIFO empty register value
 *
 ...
 *                                  - \ref UART_INTSTS_RXTOINT_Msk   : Rx time-out interrupt
 *                                  - \ref UART_INTSTS_MODEMINT_Msk  : Modem status interrupt
 *                                  - \ref UART_INTSTS_RLSINT_Msk    : Receive Line Status interrupt
 *                                  - \ref UART_INTSTS_THREINT_Msk   : Tx empty interrupt
 *                                  - \ref UART_INTSTS_RDAINT_Msk    : Rx ready interrupt
 *
...
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Baudrate, uint32_t u32Direction);
...
/*@}*/ /* end of group NUC505_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC505_UART_Driver */
