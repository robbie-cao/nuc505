...
/** @addtogroup NUC505_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC505_WWDT_EXPORTED_CONSTANTS */
...
/**
  ...
  * \hideinitializer
  */
#define WWDT_CLEAR_RESET_FLAG()  (WWDT->STATUS = WWDT_STATUS_WWDTRFC_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define WWDT_GET_RESET_FLAG() (WWDT->RSTSTS & WWDT_RSTSTS_WWDTRF_Msk ? 1 : 0)
