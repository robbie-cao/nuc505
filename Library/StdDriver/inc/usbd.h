 ...
 * $Revision: 23 $
 * $Date: 14/11/17 5:29p $
 * @brief    NUC505 USBD driver header file
 *
 * @note
...
/** @addtogroup NUC505_USBD_EXPORTED_CONSTANTS USBD Exported Constants
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
/*@}*/ /* end of group NUC505_USBD_EXPORTED_CONSTANTS */

/** @addtogroup NUC505_USBD_EXPORTED_STRUCT USBD Exported Struct
  @{
*/
...
typedef struct s_usbd_info {
    ...
    uint8_t *gu8HidCompositeDesc;  				  /*!< Pointer for HID Report descriptor */
...
/*@}*/ /* end of group NUC505_USBD_EXPORTED_STRUCT */
...
/** @addtogroup NUC505_USBD_EXPORTED_MACROS USBD Exported Macros
  @{
*/
...
/*@}*/ /* end of group NUC505_USBD_EXPORTED_MACROS */
