...
#define TEST_PAGES   128       /* 1024 pages */
#define TEST_BASE    0x0    /* 64kbytes */
...
int main(void)
{
    ...
    {
        if(buf[i] != (unsigned char)0xFF)		//Should be 0xFF after Erase
        {
            isErr = 1;
            break;
        }
    ...
    {
        if(buf[i] != (unsigned char)0xFF)		//Only Sector 1 is erased.
        {
            isErr = 1;
            break;
        }
