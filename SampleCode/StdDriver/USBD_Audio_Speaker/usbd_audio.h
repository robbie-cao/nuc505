...
#ifdef __HID__
#ifdef __KEYBOARD__
#define USBD_PID        0x1271
#elif defined __MEDIAKEY__	
#define USBD_PID        0x1272
#endif
#else
#define USBD_PID        0x1270
#endif	
...
#define AUDIO_DEF_RATE  96000
#define AUDIO_CHANNELS  2
#define AUDIO_BIT_RATE  16

#define PLAY_RATE       AUDIO_RATE       /* The audo play sampling rate. The setting is 16KHz */
#define PLAY_RATE_441K  AUDIO_RATE_441K       /* The audo play sampling rate. The setting is 16KHz */
#define PLAY_DEF_RATE		AUDIO_DEF_RATE
#define PLAY_CHANNELS   AUDIO_CHANNELS
#define PLAY_BIT_RATE   AUDIO_BIT_RATE   /* 16-bit data rate */
...
#define PLAY_RATE_441K_LO    (PLAY_RATE_441K & 0xFF)
#define PLAY_RATE_441K_MD    ((PLAY_RATE_441K >> 8) & 0xFF)
#define PLAY_RATE_441K_HI    ((PLAY_RATE_441K >> 16) & 0xFF)

#define PLAY_RATE_LO    (PLAY_RATE & 0xFF)
#define PLAY_RATE_MD    ((PLAY_RATE >> 8) & 0xFF)
#define PLAY_RATE_HI    ((PLAY_RATE >> 16) & 0xFF)

#define PLAY_DEF_RATE_LO    (PLAY_DEF_RATE & 0xFF)
#define PLAY_DEF_RATE_MD    ((PLAY_DEF_RATE >> 8) & 0xFF)
#define PLAY_DEF_RATE_HI    ((PLAY_DEF_RATE >> 16) & 0xFF)
...
#define EPB_MAX_PKT_SIZE        96000*PLAY_CHANNELS*3/1000
#define EPB_OTHER_MAX_PKT_SIZE  96000*PLAY_CHANNELS*3/1000
...
#define EPB_BUF_LEN     (0x800 - CEP_BUF_LEN - EPC_BUF_LEN)
#else
#define EPB_BUF_BASE    (CEP_BUF_BASE + CEP_BUF_LEN)
#define EPB_BUF_LEN     (0x800 - CEP_BUF_LEN)
...
#define RING_BUF_SMPL_CNT2   2048
...
#define RING_BUF_SMPL_SZ    RING_BUF_SMPL_CNT * 4
