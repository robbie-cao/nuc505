 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 14/11/10 01:52p $
 * @brief    A AMR file player demo to play AMR file in SD card to internal audio codec.
 *
 * @note
...
void InternalCODEC_Setup()
{
    ...
    I2S_SET_INTERNAL_CODEC(I2S, 0x03, 0x80);    //Left volume at full scale.
    I2S_SET_INTERNAL_CODEC(I2S, 0x04, 0x80);    //Right volume at full scale
